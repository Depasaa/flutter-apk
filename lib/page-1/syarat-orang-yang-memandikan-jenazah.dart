...
class Syaratorangyangmemandikanjenazah extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // syaratorangyangmemandikanjenaz (352:74)
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                // memandikanjenazah1LF3 (177:19)
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 20 * fem),
                width: 430 * fem,
                height: 240 * fem,
                child: Image.asset(
                  'assets/page-1/images/memandikan-jenazah-1.png',
                  fit: BoxFit.cover,
                ),
              ),
              Container(
                // autogroupc3jrTaZ (8WgoNP83xsvPUHdbHvc3JR)
                width: double.infinity,
                height: 646 * fem,
                decoration: BoxDecoration(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: SizedBox(
                              ...
                              height: 26.52 * fem,
                              child: Image.asset(
                                'assets/page-1/images/vector-kMo.png',
                                width: 13.26 * fem,
                                height: 26.52 * fem,
                              ),
                            ),
                      ...
                      child: TextButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Syaratorangyangmemandikanjenazah2()),
                          );
                        },
                        style: TextButton.styleFrom(
                          padding: EdgeInsets.zero,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: SizedBox(
                              ...
                              height: 26.52 * fem,
                              child: Image.asset(
                                'assets/page-1/images/vector-oS9.png',
                                width: 13.26 * fem,
                                height: 26.52 * fem,
                              ),
                            ),
