...
class Alat1 extends StatelessWidget {
  @override
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(
                // bahanmemandikan1T8m (177:56)
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 20 * fem),
                width: 430 * fem,
                height: 240 * fem,
                child: Image.asset(
                  'assets/page-1/images/bahan-memandikan-1.png',
                  fit: BoxFit.cover,
                ),
              ),
              Container(
                // autogroupsmhjyso (8WgheJAPZK3gtFoHbYSmhj)
                width: double.infinity,
                height: 646 * fem,
                decoration: BoxDecoration(
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      // guntinguntukmelepaskanbajuatau (177:55)
                      left: 24 * fem,
                      top: 41 * fem,
                      child: Align(
                        child: SizedBox(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            ...
                            child: SizedBox(
                              ...
                              height: 26.52 * fem,
                              child: Image.asset(
                                'assets/page-1/images/vector-6Pb.png',
                                width: 13.26 * fem,
                                height: 26.52 * fem,
                              ),
                            ),
